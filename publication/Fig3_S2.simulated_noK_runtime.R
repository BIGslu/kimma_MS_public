...
#### Save ####
ggsave(filename="figs/FigS2.simulated_noK_runtime_unpaired.pdf",
       p1a_signif, width=3, height=4.5)
ggsave(filename="figs/FigS2.simulated_noK_runtime_unpaired.png",
       p1a_signif, width=3, height=4.5)

ggsave(filename="figs/Fig3.simulated_noK_runtime_paired.pdf",
       p1b_signif, width=3, height=4.5)
ggsave(filename="figs/Fig3.simulated_noK_runtime_paired.png", 
       p1b_signif, width=3, height=4.5)
